...
export default async function ConsultationDetails({ 
  ...
  return (
    <Layout>
      <div className="p-3 sm:p-4 md:p-6 w-full max-w-4xl mx-auto bg-background dark:bg-gray-950 rounded-lg shadow-md dark:shadow-gray-800/50">
        {/* Header Section */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="w-full">
            <Link href="/consultations" className="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 mb-2 sm:mb-3">
              <FiArrowLeft className="mr-2" />
              <span className="font-medium text-sm sm:text-base">Retour aux consultations</span>
            </Link>
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 dark:text-white flex flex-wrap items-center">
              <FiUser className="mr-2 sm:mr-3 text-blue-500 dark:text-blue-400" />
              {consultation.patientName}
              {consultation.patientAge && (
                <span className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm ml-2 sm:ml-3">({consultation.patientAge} ans)</span>
              )}
            </h1>
          </div>
        </div>
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
          ...
          <div className="md:col-span-1 space-y-3 sm:space-y-4">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
              <h2 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3 text-gray-800 dark:text-white flex items-center">
                <FiUser className="mr-2 text-blue-500 dark:text-blue-400" />
                Informations patient
              </h2>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-start">
                  <FiPhone className="mt-0.5 mr-2 text-gray-500 dark:text-gray-400 flex-shrink-0" />
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Téléphone</p>
                    <p className="font-medium text-sm sm:text-base dark:text-white">{consultation.patientPhone || 'Non renseigné'}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <FiCalendar className="mt-0.5 mr-2 text-gray-500 dark:text-gray-400 flex-shrink-0" />
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Date</p>
                    <p className="font-medium text-sm sm:text-base dark:text-white">{new Date(consultation.date).toLocaleDateString('fr-FR', {
                      weekday: 'long',
                      day: 'numeric',
                      month: 'long',
                      year: 'numeric'
                ...
                <div className="flex items-start">
                  <FiMapPin className="mt-0.5 mr-2 text-gray-500 dark:text-gray-400 flex-shrink-0" />
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Adresse</p>
                    <p className="font-medium text-sm sm:text-base dark:text-white">{consultation.patientAddress || 'Non renseignée'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 sm:space-y-3">
                {consultationTreatment && (
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-2 sm:p-3 rounded-lg mb-2">
                    <div className="flex justify-between">
                      <span className="text-blue-800 dark:text-blue-200 text-sm sm:text-base">Consultation:</span>
                      <span className="font-medium text-sm sm:text-base dark:text-white">
                        {consultationTreatment.amount.toLocaleString()} FCFA
                      </span>
                    </div>
                    <div className="flex justify-between mt-1">
                      <span className="text-xs sm:text-sm text-blue-700 dark:text-blue-300">Statut:</span>
                ...
                <div className="space-y-1 sm:space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">Total:</span>
                    <span className="font-semibold text-sm sm:text-base dark:text-white">{totalCost.toLocaleString()} FCFA</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">Payé:</span>
                    <span className="font-semibold text-green-600 dark:text-green-400 text-sm sm:text-base">{totalPaid.toLocaleString()} FCFA</span>
                  </div>
                  <div className="flex justify-between items-center pt-1 sm:pt-2 border-t border-gray-100 dark:border-gray-800">
                    <span className="text-gray-600 dark:text-gray-300 font-medium text-sm sm:text-base">Reste:</span>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-800">
                  <span className="font-medium text-sm sm:text-base dark:text-white">Statut global:</span>
          ...
          <div className="md:col-span-2 space-y-3 sm:space-y-4">
            {/* Treatments Card */}
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1 sm:gap-3 mb-2 sm:mb-3">
                <h2 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white flex items-center">
                  <FiPlus className="mr-2 text-blue-500 dark:text-blue-400" />
                  Traitements
                </h2>
                <span className={`px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${
              ...
              {(consultation.treatments ?? []).length > 0 ? (
                <div className="space-y-3">
                  {(consultation.treatments ?? []).map(treatment => (
                    <div key={treatment.id} className="border border-gray-100 dark:border-gray-800 rounded-lg p-2 sm:p-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      ...
                      {treatment.status === 'PARTIAL' && (
                        <div className="mt-2 bg-gray-50 dark:bg-gray-800/50 p-1 sm:p-2 rounded text-xs sm:text-sm">
                ...
                <div className="text-center py-4 sm:py-6">
                  <p className="text-gray-500 dark:text-gray-400 mb-2 sm:mb-3">Aucun traitement enregistré</p>
                  <Link 
                    href={`/consultations/${consultation.id}/treatments/add`}
                    className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-1.5 bg-blue-50 hover:bg-blue-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-md transition-colors"
                  >
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3 sm:space-y-4">
                <NoteEditor
                  ...
                  className="border border-gray-100 dark:border-gray-800 rounded-lg p-2 sm:p-3 bg-gray-50/50 dark:bg-gray-800/30"
                />
                ...
                {(notes.assistantNote === null && notes.dentistNote === null) && (
                  <div className="text-center py-4 sm:py-6">
                    <p className="text-gray-500 dark:text-gray-400 mb-2 sm:mb-3">Aucune note enregistrée</p>
                    <Link
                      href={`/consultations/${consultation.id}/notes/add`}
                      className="inline-flex items-center gap-1 text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-1.5 bg-purple-50 hover:bg-purple-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-md transition-colors"
                    >
                      <FiPlus className="w-3 h-3 sm:w-4 sm:h-4" />
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-6">
          <Link
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1 sm:gap-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-3 sm:px-4 py-2 text-xs sm:text-sm rounded-lg transition-colors shadow-sm hover:shadow-md"
          >
          ...
          <Link 
            href={`/consultations/${consultation.id}/treatments/add`}
            className="flex-1 sm:flex-none flex items-center justify-center gap-1 sm:gap-2 bg-white hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 border border-gray-200 dark:border-gray-800 px-3 sm:px-4 py-2 text-xs sm:text-sm rounded-lg transition-colors shadow-sm hover:shadow-md"
          >
            <FiPlus className="w-3 h-3 sm:w-4 sm:h-4" />
